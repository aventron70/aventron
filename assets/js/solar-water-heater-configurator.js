...
const CITY_REFERENCE_DATA = [
    { label: "Casablanca", aliases: [], latitude: 33.5731, longitude: -7.5898 },
    { label: "Mohammedia", aliases: [], latitude: 33.6835, longitude: -7.3846 },
    { label: "Aïn Harrouda", aliases: [], latitude: 33.6372, longitude: -7.4496 },
    { label: "Tit Mellil", aliases: [], latitude: 33.5588, longitude: -7.4863 },
    { label: "Mediouna", aliases: [], latitude: 33.4529, longitude: -7.5203 },
    { label: "Dar Bouazza", aliases: [], latitude: 33.5165, longitude: -7.8222 },
    { label: "Bouskoura", aliases: [], latitude: 33.4498, longitude: -7.6511 },
    { label: "Nouaceur", aliases: [], latitude: 33.4593, longitude: -7.6112 },
    { label: "Skhirat", aliases: [], latitude: 33.8523, longitude: -7.0404 },
    { label: "Bouznika", aliases: [], latitude: 33.7895, longitude: -7.1596 },
    ...
    { label: "Assilah", aliases: [], latitude: 35.4669, longitude: -6.0332 },
    { label: "Larache", aliases: [], latitude: 35.1939, longitude: -6.1562 },
    { label: "Ksar El Kebir", aliases: [], latitude: 35.0017, longitude: -5.9056 },
    { label: "Chefchaouen", aliases: [], latitude: 35.1715, longitude: -5.2688 },
    { label: "Ouezzane", aliases: [], latitude: 34.7949, longitude: -5.5857 },
    { label: "Al Hoceïma", aliases: [], latitude: 35.2506, longitude: -3.9318 },
    { label: "Nador", aliases: [], latitude: 35.1681, longitude: -2.9335 },
    { label: "Berkane", aliases: [], latitude: 34.9218, longitude: -2.3194 },
    { label: "Taourirt", aliases: [], latitude: 34.4144, longitude: -2.8956 },
    { label: "Jerada", aliases: [], latitude: 34.3109, longitude: -2.1627 },
    { label: "Oujda", aliases: [], latitude: 34.6814, longitude: -1.9086 },
    { label: "Bouarfa", aliases: [], latitude: 32.531, longitude: -1.9635 },
    { label: "Figuig", aliases: [], latitude: 32.1081, longitude: -1.2282 },
    { label: "Fès", aliases: ["fes"], latitude: 34.0331, longitude: -5.0003 },
    { label: "Meknès", aliases: ["meknes"], latitude: 33.8935, longitude: -5.5473 },
    { label: "Ifrane", aliases: [], latitude: 33.5324, longitude: -5.1077 },
    { label: "Sefrou", aliases: [], latitude: 33.8319, longitude: -4.8306 },
    { label: "El Hajeb", aliases: [], latitude: 33.6878, longitude: -5.371 },
    { label: "Taza", aliases: [], latitude: 34.2133, longitude: -4.0083 },
    { label: "Khemisset", aliases: [], latitude: 33.8254, longitude: -6.0662 },
    { label: "Tiflet", aliases: [], latitude: 33.8942, longitude: -6.3257 },
    { label: "Rommani", aliases: [], latitude: 33.5089, longitude: -6.5887 },
    { label: "Sidi Yahya El Gharb", aliases: [], latitude: 34.5819, longitude: -6.3071 },
    { label: "Sidi Slimane", aliases: [], latitude: 34.2634, longitude: -5.9259 },
    { label: "Sidi Kacem", aliases: [], latitude: 34.2244, longitude: -5.7098 },
    { label: "Mechraâ Bel Ksiri", aliases: [], latitude: 34.5704, longitude: -5.9588 },
    { label: "Sidi Allal El Bahraoui", aliases: [], latitude: 33.8215, longitude: -6.6953 },
    ...
    { label: "Berrchid", aliases: [], latitude: 33.456, longitude: -7.5767 },
    { label: "Azemmour", aliases: [], latitude: 33.2876, longitude: -8.3433 },
    { label: "Oualidia", aliases: [], latitude: 32.7357, longitude: -9.0298 },
    { label: "Youssoufia", aliases: [], latitude: 32.2546, longitude: -8.5314 },
    { label: "Sidi Bennour", aliases: [], latitude: 32.6522, longitude: -8.4275 },
    { label: "Benguérir", aliases: [], latitude: 32.2476, longitude: -7.954 },
    { label: "Sidi Bouzid", aliases: [], latitude: 32.7833, longitude: -8.0019 },
    ...
    { label: "Khenifra", aliases: [], latitude: 32.9356, longitude: -5.6685 },
    { label: "Azilal", aliases: [], latitude: 31.9612, longitude: -6.5712 },
    { label: "Fquih Ben Salah", aliases: [], latitude: 32.5031, longitude: -6.6876 },
    { label: "Errachidia", aliases: [], latitude: 31.9314, longitude: -4.4244 },
    { label: "Midelt", aliases: [], latitude: 32.6852, longitude: -4.7451 },
    { label: "Ouarzazate", aliases: [], latitude: 30.9335, longitude: -6.937 },
    { label: "Zagora", aliases: [], latitude: 30.3306, longitude: -5.8384 },
    { label: "Tinghir", aliases: [], latitude: 31.5205, longitude: -5.5391 },
    { label: "Guelmim", aliases: [], latitude: 28.987, longitude: -10.0574 },
    { label: "Tan-Tan", aliases: [], latitude: 28.4366, longitude: -11.1042 },
    { label: "Sidi Ifni", aliases: [], latitude: 29.3797, longitude: -10.1724 },
    { label: "Laâyoune", aliases: ["laayoune"], latitude: 27.1536, longitude: -13.2033 },
    { label: "Dakhla", aliases: [], latitude: 23.6848, longitude: -15.957 },
    { label: "Smara", aliases: [], latitude: 26.7414, longitude: -11.6703 },
    { label: "Taroudant", aliases: [], latitude: 30.9397, longitude: -8.133 },
    { label: "Tiznit", aliases: [], latitude: 29.6974, longitude: -9.7316 },
    { label: "Chtouka Aït Baha", aliases: [], latitude: 30.0863, longitude: -9.3609 },
    { label: "Inezgane", aliases: [], latitude: 30.3551, longitude: -9.5364 },
    { label: "Aït Melloul", aliases: [], latitude: 30.3294, longitude: -9.4968 },
    { label: "Dcheira El Jihadia", aliases: [], latitude: 30.3604, longitude: -9.5272 },
    { label: "Tata", aliases: [], latitude: 29.75, longitude: -7.98 },
  ];
